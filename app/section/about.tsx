...
const AboutSection = () => {
    return (
        <section id="about">
            ...
            <div className="grid grid-cols-2 gap-4 bg-golden-poppy h-max">
                <div className="relative col-span-1 flex flex-col justify-center items-center my-10">
                    <Image
                        className="max-w-full size-[25rem] rounded-b-lg object-cover object-top z-10"
                        src="/img/asset-1.svg"
                        alt="Browser Placeholder"
                        width={800}
                        height={600}
                    />
                    <div className="bg-shalimar rounded-full size-[25rem] absolute"></div>
                </div>
                <div className="col-span-1 flex flex-col justify-center items-start gap-4">
                    <div className="bg-shalimar rounded-full size-20 absolute transform -translate-x-[10rem] -translate-y-40 z-0"></div>
                    ...
                    <div className="flex flex-col w-[25rem] text-white font-semibold bg-malibu rounded-md p-4 md:p-5 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 gap-4">
